...
\end{equation}
\begin{equation}
\delta(p)= \int_{-\infty}^{+\infty} \frac{d\hat{p}}{2\pi \hbar} \, e^{ i \frac{\hat{p} p}{\hbar}} \,.
\end{equation}
...
&=& \lim_{T\to\infty} \frac{1}{T} \int_0^T dt \, \int_{-\infty}^{+\infty} dp \, \int_{-\infty}^{+\infty} \frac{d\hat{p}}{2\pi \hbar} \, e^{i \frac{\hat{p} p}{\hbar}} \hat{f} \,, \\
&=& \lim_{T\to\infty} \frac{1}{T} \int_0^T dt \, \int_{-\infty}^{+\infty} d\hat{p} \, \hat{f} \int_{-\infty}^{+\infty} \frac{dp}{2\pi \hbar} \, e^{i \frac{\hat{p} p}{\hbar}}   \,, \\
&=& \lim_{T\to\infty} \frac{1}{T} \int_0^T dt \, \int_{-\infty}^{+\infty} d\hat{p} \, \hat{f} \delta(\hat{p}) \,, \\
&=& \lim_{T\to\infty} \frac{1}{T} \int_0^T dt \, \hat{f}_{\hat{p}=0} \,, \\
&=& \lim_{T\to\infty} \frac{1}{T} \int_0^T dt \, \sum_{\lambda,\lambda'} C_{\lambda,\lambda'} e^{i (\lambda-\lambda')t}\psi_\lambda(x)\psi_{\lambda'}^*(x) \,, \\
...
There is nothing wrong with a distribution that specifies the precise initial position and momentum of the particle.  However, we can only observe the Born projection---which makes the view fuzzy.
