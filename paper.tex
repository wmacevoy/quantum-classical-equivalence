...
\end{eqnarray}
Notice it does not affect the dynamics---it is merely the observable projection of the dynamics to a measurement.  We call this the Born projection, which is the Born rule, but now derived and without decoherance. This happens to be coupled to decoherence with any practical measurement device we have so far constructed.
